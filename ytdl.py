...
async def send_start(event):
    ...
    async with bot.action(event.chat_id, 'typing'):
        await bot.send_messsage("Hi✨ Welcome 👀\nI am YouTube Video/Audio Downloader😁 Created by @Psycho_Bots\nSend me YT link to get Your Video😊/audio", buttons=[
            [
              Button.url("Support❣️", url="https://t.me/PsychoBots_Chat")
            ],
            [
